						...
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="cart.html"><i class="fa fa-shopping-cart"></i>
										Cart</a></li>
								<c:choose>
									<c:when test="${param.id != null && param.pw != null}">
										<li><a href="/logout"><i class="fa fa-lock"></i>
										Logout</a></li>									
									</c:when>
									<c:otherwise>
										<li><a href="/elogin"><i class="fa fa-lock"></i>
										Login</a></li>									
									</c:otherwise>								
								</c:choose>
							</ul>
									...
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="images/home/product${emp.randomNum}.jpg" alt="" />
												<h2>$${emp.sal}</h2>
												<p>${emp.ename}</p>
												<a href="#" class="btn btn-default add-to-cart"><i
													class="fa fa-shopping-cart"></i>${emp.salGrade.grade}등급</a>
											</div>
											<div class="product-overlay">
												<div class="overlay-content">
													...
													<p>${member.dname}</p>
													<a href="#" class="btn btn-default add-to-cart"><i
														class="fa fa-shopping-cart"></i>${emp.empNo}</a>
												</div>
											</div>
										</div>
										<div class="choose">
											<ul class="nav nav-pills nav-justified">
												<li><a href="#"><i class="fa fa-plus-square"></i>${emp.job}</a></li>
												<li><a href="#"><i class="fa fa-plus-square"></i>${emp.hiredate}</a></li>
											</ul>
										</div>
									</div>								
								</div>
