				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="${pageContext.request.contextPath}/lotto/list">로또</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/rsp/rsp_game">가위바위보</a>
						</li>
						<li class="nav-item"><a class="nav-link active"
							href="${pageContext.request.contextPath}/company/glist">게시판</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/gugudan">구구단</a></li>
					</ul>
		...
		<div class="container">
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3 text-center">
					<h6 class="m-0 font-weight-bold text-primary">해당 게시판에서는 자유롭게
						글을 작성하실 수 있습니다. 그러나 규칙에 어긋날 경우 삭제될 수 있습니다.</h6>
				</div>
				<div class="card-body">
						...
						<table class="table table-bordered text-center align-middle"
							...
							<tbody>
								...
								<c:forEach var="member" items="${lists}">
									<c:forEach var="grade" items="${member.empList}">
										<c:forEach var="emp" items="${grade.empList}">
											<tr>
												<td>${member.deptno}</td>
												<td>${member.dname}</td>
												<td>${emp.ename}</td>
						...
						<div class="modal-content">
							...
							<form action="${pageContext.request.contextPath}/board/write.do"
								...
								<div class="modal-body">
									...
									<p class="my-2">
										<select
											class="w-100 bg-secondary text-white rounded border-dark-subtle"
									...
									<p class="my-2">이름</p>
									<p class="my-2">
										<input class="w-100 rounded" type="text" name="bname">
									</p>
									<p class="my-2">제목</p>
									<p class="my-2">
										<input class="w-100 rounded" type="text" name="btitle">
									</p>
									<p class="my-2 text-left">내용</p>
									<textarea name="bcontent" class="w-100 rounded" rows="6"
										cols="5"></textarea>
								</div>
								<!-- Modal footer -->
